...
import {Alert, Animated, Button, Dimensions, StyleSheet, TouchableOpacity, View} from 'react-native';
...
export default class App extends Component {
    ...
    onTilePress(row, col) {
        ...
        if (winner === 1) {
            Alert.alert("1. Oyuncu Kazandı.");
            this.initializeGame();
        } else if (winner === -1) {
            Alert.alert("2. Oyuncu Kazandı.");
            this.initializeGame();
        }
    }
    ...
    render() {
        return (
            <View style={styles.container}>
                ...
                <Button title='Yeni Oyun' onPress={this.initializeGame}/>
